        ...
        <Form onFinish={handleSubmit} ref={formRef}>
            <div className="payment__shipping">
                <div className="payment__part-info">
                    <div className="content__title">Nhập mã giảm giá của bạn?</div>
                    <Form.Item
                        name="promoCode"
                        rules={[
                            {
                    ...
                    >
                        <Input type="text" className="checkout__input input" placeholder="Mã giảm giá" />
                    </Form.Item>
                </div>
                <div className="payment__part-info">
                    <div className="content__title">Bạn muốn thanh toán bằng hình thức nào?</div>
