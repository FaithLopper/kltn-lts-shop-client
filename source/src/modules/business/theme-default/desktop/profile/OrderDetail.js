                ...
                <div className="order__detail grid">
                    ...
                    <div className="order__detail-body grid">
                        <div className="detail__content">
                            ...
                            <div>{data.ward.name + ', ' + data.district.name + ', ' + data.province.name}</div>
                            <div> </div> <br />
                        ...
                        <table className="order__bill">
                            ...
                            {data.orderItems.lenght !== 0 ? (
                                data.orderItems.map((item, index) => {
                                    return (
                                        <tr className="bill__row" key={index}>
                                            <td>{item.quantity}</td>
                                            ...
                                            <td>{formatMoney(toPlainString(item.price))}</td>
                                            <td></td>
                                        </tr>
                                    );
                                })
                            ...
                            <tr>
                                ...
                                <td style={{ fontWeight: 'bold' }}>{formatMoney(toPlainString(data.subTotal))}</td>
                            </tr>
                            <tr>
                                <td></td>
                                <td></td>
                                <td>Phí ship</td>
                                <td>{formatMoney(toPlainString(data.shippingCharge))}</td>
                            </tr>
                            <tr>
                                <td></td>
                                <td></td>
