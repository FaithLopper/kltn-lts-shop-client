...
const DeliveryAddressForm = ({
    ...
    return (
        ...
        >
            ...
            >
                <Input type="number" className="checkout__input input" placeholder="Số điện thoại" maxLength={10} />
            </Form.Item>
            <Form.Item
                name="addressDetails"
                rules={[
            ...
            <Form.Item name="isDefault" valuePropName="checked">
                <Checkbox defaultChecked={false}>Đặt làm địa chỉ mặc định</Checkbox>
            </Form.Item>
        </Form>
    );
};
